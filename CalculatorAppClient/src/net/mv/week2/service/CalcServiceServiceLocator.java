...
public class CalcServiceServiceLocator extends org.apache.axis.client.Service implements net.mv.week2.service.CalcServiceService {
    ...
    private java.lang.String CalcService_address = "http://localhost:7001/CalculatorApp/services/CalcService";
    ...
    public net.mv.week2.service.CalcService getCalcService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            net.mv.week2.service.CalcServiceSoapBindingStub _stub = new net.mv.week2.service.CalcServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (net.mv.week2.service.CalcService.class.isAssignableFrom(serviceEndpointInterface)) {
                net.mv.week2.service.CalcServiceSoapBindingStub _stub = new net.mv.week2.service.CalcServiceSoapBindingStub(new java.net.URL(CalcService_address), this);
                _stub.setPortName(getCalcServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.week2.mv.net", "CalcServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.week2.mv.net", "CalcService"));
        }
